...
class PrinceClass{
    constructor(name,age,sizeLegToFind){
        this.name = name;
        this.age = age;
        this.sizeLegToFind = sizeLegToFind;
    }
    findRightPrincess(array){
       let princess =  array.find(princess => princess.sizeLeg === this.sizeLegToFind );
        console.log(princess);
    }

}
let popel = new PopelushkaClass("Popeluska",23,124);
let princessArray = [
