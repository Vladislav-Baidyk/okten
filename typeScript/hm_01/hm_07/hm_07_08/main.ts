...
class PopelushkaClass{
    name:string;
    age:number;
    sizeLeg:number;
    constructor(name:string,age:number,sizeLeg:number){
        this.name = name;
        this.age = age;
...
class PrinceClass{
    name:string;
    age:number;
    sizeLegToFind:number;
    constructor(name:string,age:number,sizeLegToFind:number){
        this.name = name;
        this.age = age;
        this.sizeLegToFind = sizeLegToFind;
    }
    findRightPrincess(array:any[]){
       let princess:any =  array.find(princess => princess.sizeLeg === this.sizeLegToFind );
        console.log(princess);
    }

}
let popel:PopelushkaClass = new PopelushkaClass("Popeluska",23,124);
let princessArray:PopelushkaClass[] = [
...
let prince1 = new PrinceClass("Charles",20,40);
let findPrincess =  princessArray.find(princess => princess.sizeLeg === prince1.sizeLegToFind );
